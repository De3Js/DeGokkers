...
namespace gokkers
{
    public partial class Form1 : Form
    {
        ...
        {
            players[0] = new Player(names[0], name1, moneybar1, comboBox1, moneyLabel1, 250);
            players[1] = new Player(names[1], name2, moneybar2, comboBox2, moneyLabel2, 250);
            players[2] = new Player(names[2], name3, moneybar3, comboBox3, moneyLabel3, 250);
            players[3] = new Player(names[3], name4, moneybar4, comboBox4, moneyLabel4, 250);
            for (int i = 0; i < fleas.Length; i++)
            {
